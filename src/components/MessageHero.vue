  ...
  <div class="bg-gray-100 min-h-screen py-8">
    <div class="max-w-4xl mx-auto px-6">
      ...
      <div class="mb-6">
        ...
        <p class="text-sm text-gray-600">( 1 unread message )</p>
      </div>

      <!-- Contact List -->
      <div class="space-y-4">
        <!-- Contact Card 1 - Active/Unread -->
        <div 
          v-for="contact in contacts" 
          :key="contact.id"
          class="bg-white rounded-lg p-4 flex items-start gap-4 hover:shadow-md transition cursor-pointer"
          :class="{ 'border-l-4 border-green-500': contact.unread }"
        >
          <!-- Avatar -->
      ...
      contacts: [
        {
          ...
          lastMessage: 'Hi, can we reschedule, what time do I see today, If I give you a first time, which I will let me exchange a bit on my bata—to pay some front payment.',
