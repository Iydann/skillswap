  ...
  <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
    <div class="relative isolate overflow-hidden bg-gray-800 px-6 pt-16 after:pointer-events-none after:absolute after:inset-0 after:inset-ring after:inset-ring-white/10 sm:rounded-3xl sm:px-16 after:sm:rounded-3xl md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
      ...
      <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
        <h2 class="text-3xl font-semibold tracking-tight text-balance text-white sm:text-4xl">About SkillSwap</h2>
        <p class="mt-6 text-lg/8 text-pretty text-gray-300">SkillSwap is a platform that connects creative professionals and freelancers to exchange skills and collaborate on projects. Instead of monetary transactions, we facilitate skill-for-skill trades, helping you build your portfolio while getting the services you need.</p>
        <p class="mt-4 text-lg/8 text-pretty text-gray-300">Whether you're a designer, developer, writer, or marketer, SkillSwap empowers you to grow your network and complete projects through meaningful collaboration.</p>
      ...
      <div class="relative mt-16 h-80 lg:mt-40">
        <img src="../assets/company.png" alt="App screenshot" class="absolute top-0 left-0 w-144 max-w-none rounded-md bg-white/5 ring-1 ring-white/10" />
      </div>
    </div>
  </div>
</div>
